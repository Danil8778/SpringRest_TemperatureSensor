...
public class Client {
    ...
    public static void main(String[] args) {
        ...
        final String sensorName = "FirstSensor7";
        ...
        for (int i = 0; i < 500; i++) {
            ...
            sendMeasurement(minTemperature + (random.nextDouble() *
                    maxTemperature), random.nextBoolean(),
                    sensorName);
        }
    ...
    private static void sendMeasurement(double value, boolean raining, String sensorName){
        ...
        makePostRequestJSONData(url, jsonData);
    }

    private static void registerSensor(String sensorName) {
        final var url ="http://localhost:8080/sensors/registration";
    ...
    private static void makePostRequestJSONData(String url, Map<String, Object> jsonData){
